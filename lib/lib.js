    ...
    hero: {
        ...
        roll_atk: function(act, amt) {
            ...
            let updates = {
                ...
                'data.stats.total_hits': act.data.data.stats.total_hits + hits.length,
            }
            if(hits.length > 0) {
                result += `
                    <p>${act.name} lands ${hq.pluralize(hits.length, 'hit', 'hits')}</p>
                `;
            ...
            hq.dialog.choice_prompt(
                ...
                () => {
                    ...
                    if (tgt) {
                        ...
                        hq.chat.send('Genie', `You must select a target to attack.`);
                    }
                },
